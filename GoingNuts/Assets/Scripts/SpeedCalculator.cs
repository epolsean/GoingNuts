...
public class SpeedCalculator : MonoBehaviour {
	...
	void Start () {
        ...
        length3 = Mathf.Sqrt(Mathf.Pow(node2.position.x - node5.position.x, 2) + Mathf.Pow(node2.position.z - node5.position.z, 2));
        ...
        //print("Length 4: " + length4 + " / Percentage 4: " + percentage4);
	}
